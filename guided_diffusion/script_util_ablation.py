...
def create_model_nopgfr(
    ...
    return IntegratedUNetModel_NoPGFR(
...
def create_model_and_diffusion_notransformer(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    model = create_model_notransformer(
        image_size,
        num_channels,
        num_res_blocks,
        channel_mult=channel_mult,
...
def create_model_notransformer(
    image_size,
    num_channels,
    num_res_blocks,
    channel_mult="",
...
def create_model_and_diffusion_nocdff(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
...
def create_model_nocdff(
    ...
    return IntegratedUNetModel_NoCDFF(
        image_size=image_size,
        in_channels=4,
        model_channels=num_channels,
        out_channels=2,#(3 if not learn_sigma else 6),
