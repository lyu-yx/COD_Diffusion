...
from guided_diffusion.script_util_transformer_LN_pgfr_out_pos_dualfusion import (
...
if __name__ == "__main__":
    wandb.init(project="Diffusion", name="transformer_LN_pgfr_out_pos_dualfusion")
    main()
