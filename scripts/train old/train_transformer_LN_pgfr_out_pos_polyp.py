...
from guided_diffusion.script_util_transformer_LN_pgfr_out_pos import (
...
def main():
    ...
    train_loader = get_loader(image_root=args.train_root + 'images/',
                              ...
                              num_workers=4)
    val_loader = test_dataset(image_root=args.val_root + 'images/',
                              gt_root=args.val_root + 'masks/',
                              edge_root=args.val_root + 'edges/',
